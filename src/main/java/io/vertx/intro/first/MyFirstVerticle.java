...
public class MyFirstVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> fut) {
        ...
        router.route("/").handler(routingContext -> {
            ...
            response
                ...
                .end("<h1>Hello Alis Welcome to vert.x world! This is My first Vert.x application</h1>");
        });
    ...
    //Insert method for insert query
    ...
    //Select query for get the all articles
    ...
    //Select query for get the relevant article according to the id
    ...
    //Update Query for Update the relevant article according to the id
    ...
    //Delete query for delete the article according to the relevant id
        ...
        return connection.rxQuery("SELECT * FROM articles")
            .flatMap(rs -> {
                if (rs.getResults().isEmpty()) {
                    Article article1 = new Article("This is a new testing article  Title",
                        "https://en.wikipedia.org/wiki/Fallacies_of_distributed_computing");
                    Article article2 = new Article("this is second title",
    ...
    //Delete an existing article according to the id  HTTP method
    ...
    //Display existing article according to the id  HTTP method
    ...
    //Update an existing article according to the id  HTTP method
